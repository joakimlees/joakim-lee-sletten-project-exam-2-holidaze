export function FormField({ name, value, title, register, htmlFor, labelText, pattern, required, type, placeholder, errorText }) {
  return (
    <div className="flex flex-col my-2">
      ...
      <p className="text-secondary text-sm font-paragraph">{errorText}</p>
    </div>
  );
}
