...
export const userSchema = yup
  .object({
    ...
    role: yup.boolean().oneOf([true], "Please choose if you want to register as a customer or manager").required("Please choose if you want to register as a customer or manager"),
  })
  .required();
