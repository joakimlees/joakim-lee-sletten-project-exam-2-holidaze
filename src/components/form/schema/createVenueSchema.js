...
export const createVenueSchema = yup
  .object({
    ...
    meta: yup.object().shape({
      wifi: yup.boolean().required("do your venue have wifi?"),
      parking: yup.boolean().required("do your venue include parking?"),
      breakfast: yup.boolean().required("do your venue offer included breakfast?"),
      pets: yup.boolean().required("is pets allowed in your venue?"),
    }),
